...
export const ALLOWED = {
  manager:   ["sales_orders","sales_draft","sales_create","purchase","wh_in","wh_out","wh_stock","pc_products","pc_customers","pc_suppliers","finance","settings","settings_payment","settings_numformat","settings_docnum","admin_clear","users","dashboard","rp_sales","rp_preorder","rp_staff","rp_finance","debt_cust","debt_ncc"],
